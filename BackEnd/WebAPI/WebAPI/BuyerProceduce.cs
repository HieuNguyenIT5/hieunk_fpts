...
public class BuyerProceduce : IProceduceModel<Buyer>
{
    ...
    public bool Update(OracleConnection connection, Buyer obj)
    {
        ...
        command
            .Parameters
            .Add("id", OracleDbType.Int32, ParameterDirection.Input).Value               = obj.id;
        command
            .Parameters
            .Add("name", OracleDbType.Varchar2, ParameterDirection.Input).Value          = obj.name;
        command
            .Parameters
            .Add("paymentMethod", OracleDbType.Varchar2, ParameterDirection.Input).Value = obj.paymentmethod;
        command
            .Parameters
            .Add("success", OracleDbType.Int32, ParameterDirection.Output);
    ...
    public bool Delete(OracleConnection connection, int id)
    {
        ...
        command
            .Parameters
            .Add("id", OracleDbType.Varchar2, ParameterDirection.Input).Value = id;
        command
            .Parameters
            .Add("out_success", OracleDbType.Int32, ParameterDirection.Output);
        command.ExecuteNonQuery();
